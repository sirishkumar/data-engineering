...
if __name__ == '__main__':
    ...
    parser.add_argument('--table_name', default="yello_taxi_trips", help='name of the table where we will write the results to')
    parser.add_argument('--url', default="https://s3.amazonaws.com/nyc-tlc/trip+data/yellow_tripdata_2021-01.csv", help='url of the csv file')
